...
final class AchievementManager: ObservableObject {
    ...
    static let allMilestones: [MilestoneDefinition] = [
        ...
        .init(id: "daily_5",    dimension: .daily,    thresholdMinutes: 5,
              candyReward: 1,   titleZh: "入门仪式 — 开始了",    titleEn: "First ritual — it starts",
        ...
        .init(id: "daily_15",   dimension: .daily,    thresholdMinutes: 15,
              candyReward: 1,   titleZh: "标准模式 — 稳了",      titleEn: "Standard mode — steady",
        ...
        .init(id: "daily_30",   dimension: .daily,    thresholdMinutes: 30,
              candyReward: 2,   titleZh: "沉浸模式 — 认真的",    titleEn: "Immersion mode — serious now",
        ...
        .init(id: "daily_120",  dimension: .daily,    thresholdMinutes: 120,
              candyReward: 3,   titleZh: "全浸模式 — 疯了(褒义)", titleEn: "Full immersion — obsessed (in a good way)",
              subtitleZh: "你今天活在两种语言里",               subtitleEn: "You lived in two languages today"),

        // 每周积累
        .init(id: "week_30",    dimension: .weekly,   thresholdMinutes: 30,
              candyReward: 2,   titleZh: "轻听周 — 起步",        titleEn: "Light week — getting started",
        ...
        .init(id: "week_120",   dimension: .weekly,   thresholdMinutes: 120,
              candyReward: 4,   titleZh: "习惯周 — 形成节律",    titleEn: "Habit week — finding the rhythm",
        ...
        .init(id: "week_300",   dimension: .weekly,   thresholdMinutes: 300,
              candyReward: 8,   titleZh: "专注周 — 有意投入",    titleEn: "Focused week — intentional effort",
        ...
        .init(id: "week_600",   dimension: .weekly,   thresholdMinutes: 600,
              candyReward: 15,  titleZh: "全力周 — 本周是你的",  titleEn: "Full-throttle week — this week was yours",
        ...
        .init(id: "month_120",  dimension: .monthly,  thresholdMinutes: 120,
              candyReward: 3,   titleZh: "初见月 — 刚刚认识",    titleEn: "First meeting month",
        ...
        .init(id: "month_480",  dimension: .monthly,  thresholdMinutes: 480,
              candyReward: 8,   titleZh: "渐入月 — 开始熟悉",    titleEn: "Warming up month",
        ...
        .init(id: "month_1200", dimension: .monthly,  thresholdMinutes: 1200,
              candyReward: 20,  titleZh: "沉淀月 — 真的在学",    titleEn: "Depth month — genuinely learning",
        ...
        .init(id: "month_2400", dimension: .monthly,  thresholdMinutes: 2400,
              candyReward: 45,  titleZh: "沉浸月 — 这个月你活在别的语言里", titleEn: "Immersion month — you lived in another language",
        ...
        .init(id: "life_600",   dimension: .lifetime, thresholdMinutes: 600,
              candyReward: 8,   titleZh: "耳朵开了",             titleEn: "Ears awakened",
        ...
        .init(id: "life_1800",  dimension: .lifetime, thresholdMinutes: 1800,
              candyReward: 15,  titleZh: "音感成形",             titleEn: "Phonetic sense forming",
        ...
        .init(id: "life_4500",  dimension: .lifetime, thresholdMinutes: 4500,
              candyReward: 30,  titleZh: "语感初现",             titleEn: "Language intuition emerging",
        ...
        .init(id: "life_9000",  dimension: .lifetime, thresholdMinutes: 9000,
              candyReward: 60,  titleZh: "拐点到了",             titleEn: "Inflection point",
        ...
        .init(id: "life_18000", dimension: .lifetime, thresholdMinutes: 18000,
              candyReward: 100, titleZh: "字幕不再是拐杖",        titleEn: "Subtitles are optional now",
        ...
        .init(id: "life_30000", dimension: .lifetime, thresholdMinutes: 30000,
              candyReward: 180, titleZh: "真的活在里面了",        titleEn: "Actually living in it",
        ...
        .init(id: "life_45000", dimension: .lifetime, thresholdMinutes: 45000,
              candyReward: 300, titleZh: "语言成了习惯",          titleEn: "Language as lifestyle",
        ...
        .init(id: "life_60000", dimension: .lifetime, thresholdMinutes: 60000,
              candyReward: 500, titleZh: "另一个自己",            titleEn: "Another self",
